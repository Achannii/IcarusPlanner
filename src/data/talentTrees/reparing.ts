...
export const repairingTree = {
    talents: defineTalentTree("Repairing", [
        ...
        },
        {
            ...
            benefits: [
                [{value: 25, desc: "+{0}% Chance to Repair a Building Piece Instantly", category: "Flag"}],
            ],
            position: [4, 3.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 10, desc: "Extinguished Building Pieces have Reduced Burn Chance for {0} seconds", category: "Flag"}],
            ],
            position: [4, 6.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 1, desc: "Can Throw Your Fire Whacker", category: "Flag"}],
            ],
            position: [5, 6.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 10, desc: "Repaired Building Pieces have Increased Wind Damage Resistance for {0} seconds", category: "Flag"}],
            ],
            position: [4, 1.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 10, desc: "+{0}% Damage vs Creature Bones", category: "Utility"}],
                [{value: 20, desc: "+{0}% Damage vs Creature Bones", category: "Utility"}],
            ],
            position: [2, 3.0],
    ...
    fullTracks: [
        ...
        { start: "Ready To Work", path: [[0, 7.0]], end: "Speedy Whacks" },
        { start: "Ready To Work", path: [[0, 5.0]], end: "First Responder" },
        { start: "Ready To Work", path: [[0, 1.0]], end: "Hammer Time I" },
        { start: "Hammer Time I", end: "Hardy Hammer" },
        { start: "Boneshatter", path: [[2, 1.0]], end: "Hardy Hammer" },
        { start: "Whacker Endurance", path: [[3, 3.0]], end: "With One Swing" },
        { start: "Hardy Hammer", path: [[3, 3.0]], end: "With One Swing" },
        { start: "First Responder", end: "Whacker Endurance" },
        { start: "Boneshatter", path: [[2, 5.0]], end: "Whacker Endurance" },
        { start: "Hardy Whacker", path: [[4, 7.0]], end: "Lingering Extinguishing" },
        { start: "Whacker Endurance", path: [[4, 5.0]], end: "Lingering Extinguishing" },
        ...
        { start: "First Responder", path: [[2, 5.0]], end: "Boneshatter" },
        { start: "Hammer Time I", path: [[2, 1.0]], end: "Boneshatter" },
    ] as FullTrack[],
};
