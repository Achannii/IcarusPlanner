...
export const cookingTree = {
    talents: defineTalentTree("Cooking", [
        ...
        },
        {
            ...
            benefits: [
                [{value: 10, desc: "+{0}% Food Effects Duration", category: "Combat"}],
                [{value: 15, desc: "+{0}% Food Effects Duration", category: "Combat"}],
                [{value: 20, desc: "+{0}% Food Effects Duration", category: "Combat"}],
            ],
            position: [2, 4.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 1, desc: "Can Eat Spoiled Food", category: "Flag"}],
            ],
            position: [6, 2.5],
        ...
        },
        {
            ...
            benefits: [
                [{value: 1, desc: "+{0} Space in Stomach", category: "Buff"}],
            ],
            position: [8, 4.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 1, desc: "Created Crop Plot Crops will not Wither", category: "Flag"}],
            ],
            position: [7, 6.5],
        ...
        },
        {
            ...
            benefits: [
                [{value: 15, desc: "+{0}% Dried Meat Modifier Effectiveness", category: "Buff"}],
                [{value: 30, desc: "+{0}% Dried Meat Modifier Effectiveness", category: "Buff"}],
            ],
            position: [3, 2.5],
        ...
        },
        {
            ...
            prerequisites: ["Naturally Preserved"],
            benefits: [
                [{value: 15, desc: "+{0}% Fruit and Vegetable Modifier Effectiveness", category: "Buff"}],
                [{value: 30, desc: "+{0}% Fruit and Vegetable Modifier Effectiveness", category: "Buff"}],
            ],
            position: [4, 1.0],
    ...
    fullTracks: [
        { start: "Naturally Preserved", path: [[2, 1.0]], end: "Long Lasting Effects" },
        ...
        { start: "Long Lasting Effects", path: [[5, 4.0]], end: "Superfoods" },
        { start: "Fresh is Best", path: [[8, 6.5]], end: "Food Pyramid" },
        { start: "Long Lasting Effects", end: "Food Pyramid" },
        { start: "Green Thumb", end: "Fresh is Best" },
        { start: "Gathering Guru", path: [[5, 6.5]], end: "Fresh is Best" },
        { start: "Filling Meals", path: [[1, 4.0]], end: "Well Laid Fire" },
        { start: "Green Thumb", path: [[1, 6.5]], end: "All-Nighter" },
        { start: "Naturally Preserved", path: [[3, 1.0]], end: "Carnivore" },
        { start: "Naturally Preserved", end: "Vegetarian" },
        { start: "Green Thumb", path: [[3, 6.5]], end: "Get up and go" },
        { start: "Long Lasting Effects", path: [[4, 4.0]], end: "The Old One-Two" },
        { start: "Long Lasting Effects", path: [[5, 4.0]], end: "Gathering Guru" },
        { start: "Green Thumb", path: [[5, 6.5]], end: "Gathering Guru" },
        { start: "Neat and Tidy", end: "Shoot the Breeze" },
        { start: "Shoot the Breeze", end: "Get off my Lawn" },
        { start: "Green Thumb", path: [[2, 6.5]], end: "Neat and Tidy" },
        { start: "Green Thumb", path: [[5, 6.5]], end: "Speed-Gro" },
        { start: "Green Thumb", path: [[6, 6.5]], end: "Bumper Crop" },
        { start: "Fresh is Best", path: [[8, 6.5]], end: "Sturdy Stalks" },
        { start: "Green Thumb", path: [[6, 6.5]], end: "Prolific Crop" },
        { start: "Green Thumb", path: [[1, 6.5]], end: "Seed Master" },
    ] as FullTrack[],
};
