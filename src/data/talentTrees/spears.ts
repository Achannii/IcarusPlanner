...
export const spearsTree = {
    talents: defineTalentTree("Spears", [
        {
            ...
            benefits: [
                [{value: 10, desc: "+{0}% Attack Speed with Spears", category: "Combat"}],
                [{value: 15, desc: "+{0}% Attack Speed with Spears", category: "Combat"}],
                [{value: 20, desc: "+{0}% Attack Speed with Spears", category: "Combat"}],
            ],
            position: [1, 2.25],
        ...
        },
        {
            ...
            benefits: [
                [{value: 10, desc: "+{0}% Speed of Thrown Spears", category: "Combat"}],
                [{value: 15, desc: "+{0}% Speed of Thrown Spears", category: "Combat"}],
            ],
            position: [6, 8.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: -20, desc: "+{0}% Resource Cost of Crafted Spears", category: "Utility"}],
            ],
            position: [4, 2.25],
        ...
        },
        {
            ...
            prerequisites: ["Deadly Thrust I"],
            benefits: [
                [{value: 25, desc: "+{0}% Maximum Health for Crafted Spears", category: "Utility"}],
            ],
            position: [4, 4.25],
        ...
        },
        {
            ...
            benefits: [
                [{value: 1, desc: "Thrown Spears are highlighted", category: "Flag"}],
            ],
            position: [4, 6.5],
    ...
    fullTracks: [
        { start: "Strong Thrust I", path: [[1, 1.0]], end: "Quick Thrust" },
        { start: "Efficient Crafter I", path: [[1, 3.5]], end: "Quick Thrust" },
        { start: "Quick Thrust", path: [[2, 2.25]], end: "Strong Thrust II" },
        { start: "Quick Thrust", path: [[2, 2.25]], end: "Deadly Thrust I" },
        { start: "From Afar I", path: [[2, 6.5]], end: "Deadly Thrust I" },
        { start: "Deadly Thrust I", path: [[3, 4.25]], end: "Deadly Thrust II" },
        { start: "Spear Quick Draw", path: [[1, 7.75]], end: "From Afar I" },
        { start: "Seasoned Spearman", path: [[1, 5.25]], end: "From Afar I" },
        { start: "From Afar I", path: [[2, 6.5]], end: "From Afar II" },
        { start: "There It Is", end: "Long Reach I" },
        { start: "Long Reach I", path: [[6, 6.5]], end: "Long Reach II" },
        ...
        { start: "Deadly Thrust I", path: [[2, 6.5]], end: "There It Is" },
        { start: "From Afar II", path: [[2, 6.5]], end: "There It Is" },
        { start: "From Afar I", end: "There It Is" },
        { start: "Quick Thrust", end: "Could Go All Day" },
        { start: "Deadly Thrust I", path: [[2, 2.25]], end: "Could Go All Day" },
        { start: "Long Reach I", path: [[6, 6.5]], end: "Deep Wounds" },
