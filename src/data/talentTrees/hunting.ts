...
export const huntingTree = {
    talents: defineTalentTree("Hunting", [
        {
            ...
            benefits: [
                [{value: 1, desc: "Double Yield from Skinning Baby Animals", category: "Flag"}],
            ],
            position: [8, 4.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 1, desc: "Small Creatures are Highlighted when Aiming", category: "Combat"}],
            ],
            position: [3, 2.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 1, desc: "Medium Creatures are Highlighted when Aiming", category: "Combat"}],
            ],
            position: [4, 2.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 1, desc: "Large Creatures are Highlighted when Aiming", category: "Combat"}],
            ],
            position: [5, 1.0],
        ...
        },
        {
            ...
            prerequisites: ["Strong Shoulders"],
            benefits: [
                [{value: 1, desc: "Can see Creature Alert Level and Health", category: "Combat"}],
            ],
            position: [2, 1.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 1, desc: "Can see World Bosses on the Map", category: "Flag"}],
            ],
            position: [7, 5.5],
        ...
        },
        {
            ...
            benefits: [
                [{value: 15, desc: "+{0}% Damage vs Creature Bones", category: "Utility"}],
                [{value: 30, desc: "+{0}% Damage vs Creature Bones", category: "Utility"}],
            ],
            position: [5, 3.0],
    ...
    fullTracks: [
        { start: "Big Game Hunter", path: [[7, 4.0]], end: "Cold Hearted" },
        { start: "Careful Skinner", end: "Cold Hearted" },
        { start: "Quick Clean Up", path: [[5, 4.0]], end: "Cold Hearted" },
        { start: "Trained Hunter", end: "Careful Skinner" },
        { start: "Blueprint: Ghillie Armor", end: "Blueprint: Arctic Armor" },
        { start: "Big Game Hunter", path: [[7, 7.0]], end: "Blueprint: Arctic Armor" },
        { start: "Strong Shoulders", end: "Sense Small Animals" },
        { start: "Sense Small Animals", end: "Sense Medium Animals" },
        { start: "Sense Medium Animals", path: [[5, 2.0]], end: "Sense Megafauna" },
        { start: "Quick Getaway", end: "Without a Sound" },
        { start: "Leather Breakdown", path: [[2, 4.0]], end: "Without a Sound" },
        { start: "Chase 'em Down", path: [[1, 3.0]], end: "Strong Shoulders" },
        { start: "Fine Butcher I", path: [[1, 1.0]], end: "Strong Shoulders" },
        { start: "Without a Sound", path: [[3, 6.0]], end: "Blueprint: Ghillie Armor" },
        { start: "Bone Collector", path: [[1, 7.0]], end: "Quick Getaway" },
        { start: "Swift Stalker", path: [[1, 5.0]], end: "Quick Getaway" },
        { start: "Swift Stalker", path: [[1, 5.0]], end: "Leather Breakdown" },
        { start: "Chase 'em Down", path: [[1, 3.0]], end: "Leather Breakdown" },
        { start: "Careful Skinner", path: [[5, 4.0]], end: "Fine Butcher II" },
        { start: "Careful Skinner", path: [[6, 4.0]], end: "Bone Collector II" },
        { start: "Quick Clean Up", path: [[5,4.0],[6, 4.0]], end: "Bone Collector II" },
        { start: "Strong Shoulders", path: [[2, 2.0]], end: "Health Bars" },
        { start: "Careful Skinner", path: [[6, 4.0]], end: "Chase 'em Down II" },
        { start: "Quick Clean Up", path: [[5,4.0],[6, 4.0]], end: "Chase 'em Down II" },
        { start: "Blueprint: Ghillie Armor", path: [[7, 7.0]], end: "Big Game Hunter" },
        { start: "Careful Skinner", path: [[7, 4.0]], end: "Big Game Hunter" },
        { start: "Quick Clean Up", path: [[5,4.0],[7, 4.0]], end: "Big Game Hunter" },
        { start: "Leather Breakdown", end: "Trained Hunter" },
        { start: "Without a Sound", path: [[2, 4.0]], end: "Trained Hunter" },
        { start: "Bone Collector II", end: "Brittle Bones" },
        { start: "Careful Skinner", path: [[5, 4.0]], end: "Quick Clean Up" },
        { start: "Sense Medium Animals", path: [[5, 2.0]], end: "Quick Clean Up" },
    ] as FullTrack[],
};