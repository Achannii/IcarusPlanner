...
export const fishingTree = {
    ...
    fullTracks: [
        ...
        { start: "Efficient Fisher", path: [[2.5, 2.0]], end: "Hefty catch" },
        { start: "Efficient Fisher", path: [[2.5, 5.0]], end: "That's a big one" },
        { start: "Hefty catch", path: [[3.5, 3.5]], end: "Fisher's Haul" },
        { start: "That's a big one", path: [[3.5, 3.5]], end: "Fisher's Haul" },
        { start: "Fisher's Haul", end: "Steady Breathing" },
        { start: "Fisher's Haul", end: "One with the water" },
        { start: "Steady Breathing", path: [[4.5, 0.5]], end: "Saltiest Catch" },
        { start: "One with the water", path: [[4.5, 6.5]], end: "Freshest Catch" },
        { start: "Fisher's Haul", path: [[4.5, 4.5]], end: "Pescatarian" },
        { start: "Fisher's Haul", path: [[4.5, 2.5]], end: "Deadliest Catch" },
        { start: "Deadliest Catch", path: [[6.5, 3.5]], end: "The Golden Zone" },
        { start: "Pescatarian", path: [[6.5, 3.5]], end: "The Golden Zone" },
        { start: "The Golden Zone", path: [[7.5, 5.0]], end: "Medium Game Fisher" },
        { start: "The Golden Zone", path: [[7.5, 2.0]], end: "Big Game Fisher" },
    ] as FullTrack[],
};