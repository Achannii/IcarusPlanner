...
export const husbandryTree = {
    talents: defineTalentTree("Husbandry", [
        {
            ...
            benefits: [
                [{value: 1, desc: "Nearby Juveniles Tame Faster", category: "Flag"}],
            ],
            position: [6, 2.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 1, desc: "Juvenile Creature Does Not Pose Any Threat To Predators", category: "Flag"}],
            ],
            position: [8, 4.5],
        ...
        },
        {
            ...
            benefits: [
                [{value: -2, desc: "+{0} Minimum Taming Temperature", category: "CreatureTaming"}, {value: 2, desc: "+{0} Maximum Taming Temperature", category: "CreatureTaming"}],
                [{value: -4, desc: "+{0} Minimum Taming Temperature", category: "CreatureTaming"}, {value: 4, desc: "+{0} Maximum Taming Temperature", category: "CreatureTaming"}],
            ],
            position: [1, 1.0],
        ...
        },
        {
            ...
            prerequisites: ["Nurturing Presence"],
            benefits: [
                [{value: -5, desc: "+{0} Minimum Taming Temperature", category: "CreatureTaming"}],
                [{value: -10, desc: "+{0} Minimum Taming Temperature", category: "CreatureTaming"}],
            ],
            position: [7, 1.0],
        ...
        },
        {
            ...
            prerequisites: ["Nurturing Presence"],
            benefits: [
                [{value: 5, desc: "+{0} Maximum Taming Temperature", category: "CreatureTaming"}],
                [{value: 10, desc: "+{0} Maximum Taming Temperature", category: "CreatureTaming"}],
            ],
            position: [7, 3.0],
    ...
    fullTracks: [
        { start: "Adaptive Training", path: [[6, 1.0]], end: "Nurturing Presence" },
        { start: "Long Haul", end: "Like the wind" },
        { start: "Well Cared For", path: [[0, 3.0]], end: "Efficient Feeding" },
        { start: "Grazing for the herd", path: [[0, 3.0]], end: "Efficient Feeding" },
        { start: "Back in the Saddle", path: [[0, 7.0]], end: "Energetic Encouragement" },
        { start: "Long Haul", path: [[6, 7.0]], end: "Beasts Endurance" },
        { start: "Relaxed Rider", end: "Long Haul" },
        { start: "Hardy Diet", path: [[3, 7.0]], end: "Long Haul" },
        { start: "Nurturing Presence", path: [[6, 4.5]], end: "(Still) One With Nature" },
        { start: "Efficient Feeding", end: "Adaptive Training" },
        { start: "Energetic Encouragement", end: "Relaxed Rider" },
        { start: "Desert Training", path: [[8, 3.0]], end: "In Your Element" },
        { start: "Arctic Training", path: [[8, 1.0]], end: "In Your Element" },
        { start: "Relaxed Rider", path: [[3, 7.0]], end: "Hardy Diet" },
		{ start: "Rapid Adoption", path: [[2, 5.0]], end: "Hardy Diet" },
		{ start: "Efficient Feeding", path: [[1, 4.0], [2, 4.0], [2, 5.0]], end: "Hardy Diet" },
		{ start: "Hardy Diet", path: [[3, 4.0]], end: "Act Natural" },
        { start: "Nurturing Presence", path: [[7, 2.0]], end: "Arctic Training" },
        { start: "Nurturing Presence", path: [[7, 2.0]], end: "Desert Training" },
        { start: "Grazing for the herd", path: [[0, 5.0]], end: "Rapid Adoption" },
        { start: "Back in the Saddle", path: [[0, 5.0]], end: "Rapid Adoption" },
        { start: "Hardy Diet", end: "Act Natural" },
        { start: "Hardy Diet", path: [[4, 5.0]], end: "Kill Command" },
    ] as FullTrack[],
};