    ...
    talents: defineTalentTree("Blades", [
        {
            ...
            prerequisites: [],
            benefits: [
                [{value: 5, desc: "+{0}% Attack Speed with Knives", category: "Combat"}],
                [{value: 10, desc: "+{0}% Attack Speed with Knives", category: "Combat"}],
                [{value: 15, desc: "+{0}% Attack Speed with Knives", category: "Combat"}],
            ],
            position: [0, 6.5],
        ...
        },
        {
            ...
            benefits: [
                [{value: 5, desc: "+{0}% Speed of Thrown Knives", category: "Combat"}],
                [{value: 8, desc: "+{0}% Speed of Thrown Knives", category: "Combat"}],
                [{value: 10, desc: "+{0}% Speed of Thrown Knives", category: "Combat"}],
            ],
            position: [6, 0.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 5, desc: "+{0}% Skinning Speed", category: "Utility"}],
                [{value: 10, desc: "+{0}% Skinning Speed", category: "Utility"}],
                [{value: 20, desc: "+{0}% Skinning Speed", category: "Utility"}],
            ],
            position: [6, 4.5],
        ...
        },
        {
            ...
            benefits: [
                [{value: 5, desc: "{0}% chance to Kill Instantly with a Knife while Crouching", category: "Combat"}],
            ],
            position: [8, 0.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 100, desc: "{0}% Chance for Thrown Knife Critical Hits to Immobilise Targets", category: "Utility"}],
            ],
            position: [8, 6.5],
        ...
        },
        {
            ...
            benefits: [
                [{value: 1, desc: "Thrown Knives are highlighted", category: "Flag"}],
            ],
            position: [2, 0.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 20, desc: "+{0} Felling Damage", category: "Utility"}],
            ],
            position: [5, 5.5],
        ...
        },
        {
            ...
            benefits: [
                [{value: 25, desc: "+{0}% Maximum Health for Crafted Knives", category: "Utility"}],
            ],
            position: [1, 2.75],
        ...
        },
        {
            ...
            prerequisites: ["Strong Arm"],
            benefits: [
                [{value: 15, desc: "+{0}% Speed of Thrown Knives", category: "Combat"}],
                [{value: 18, desc: "+{0}% Speed of Thrown Knives", category: "Combat"}],
                [{value: 20, desc: "+{0}% Speed of Thrown Knives", category: "Combat"}],
            ],
            position: [7, 1.0],
