...
export const buildingTree = {
    talents: defineTalentTree("Building", [
        ...
        },
        {
            ...
            benefits: [
                [{value: 25, desc: "+{0}% Crafting Speed of Deployable Items", category: "Flag"}],
            ],
            position: [5, 5.5],
        ...
        },
        {
            ...
            benefits: [
                [{value: -25, desc: "{0}% reduced chance to set Fire on Wooden Buildables", category: "Flag"}],
            ],
            position: [3, 0.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 25, desc: "+{0}% Wind Resistance on Wooden Buildables", category: "Flag"}],
            ],
            position: [2, 0.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 100, desc: "+{0}% Maximum Health for Lightning Rods", category: "Utility"}],
                [{value: 300, desc: "+{0}% Maximum Health for Lightning Rods", category: "Utility"}],
                [{value: 500, desc: "+{0}% Maximum Health for Lightning Rods", category: "Utiltiy"}],
            ],
            position: [6, 1.5],
        ...
        },
        {
            ...
            benefits: [
                [{value: 10, desc: "+{0}% Maximum Health for Crafted Wood Buildables", category: "Utility"}],
                [{value: 20, desc: "+{0}% Maximum Health for Crafted Wood Buildables", category: "Utility"}],
            ],
            position: [1, 0.0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 10, desc: "+{0}% Smelting Speed", category: "Utility"}],
                [{value: 15, desc: "+{0}% Smelting Speed", category: "Utility"}],
            ],
            position: [5, 3.5],
